      ...
      <div className={styles.container}>
        <div className={styles.terms__content}>
          ...
          <p className={styles.description}>
            ...
            recorded by SARMIZEGETUSA.MD and how we use it. If you have
            ...
            collect in SARMIZEGETUSA.MD. This policy is not applicable to any
          ...
          <p className={styles.description}>
            ...
            fraud By contacting the official representatives of SARMIZEGETUSA.MD
          ...
          <p className={styles.description}>
            SARMIZEGETUSA.MD follows a standard procedure of using log files.
          ...
          <p className={styles.description}>
            Like any other website, SARMIZEGETUSA.MD uses 'cookies'. These
          ...
          <p className={styles.description}>
            ...
            advertising partners of SARMIZEGETUSA.MD. Third-party ad servers or
            ...
            that appear on SARMIZEGETUSA.MD, which are sent directly to users'
            ...
            SARMIZEGETUSA.MD has no access to or control over these cookies that
            are used by third-party advertisers.
          </p>
          <p className={styles.title}>Third Party Privacy Policies</p>
          <p className={styles.description}>
            SARMIZEGETUSA.MD Privacy Policy does not apply to other advertisers
          ...
          <p className={styles.description}>
            ...
            SARMIZEGETUSA.MD does not knowingly collect any Personal
